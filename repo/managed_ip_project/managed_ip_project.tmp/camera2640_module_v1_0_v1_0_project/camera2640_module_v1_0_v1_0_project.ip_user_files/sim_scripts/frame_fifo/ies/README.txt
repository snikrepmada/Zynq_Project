...
#
# Generated by export_simulation on Sun Feb 14 14:49:48 -0500 2016
#
################################################################################
...
switch to the './frame_fifo.sh' script.

./frame_fifo.sh -reset_run
...
./frame_fifo.sh -noclean_files

For more information on the script, please type './frame_fifo.sh -help'.
